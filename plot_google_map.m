...
%                     To set the key, use:
%                     plot_google_map('APIKey','AIzaSyCTcvvtvrqQbiI9UBiXvCWYHVLB7LmlNks')
    ...
    for idx = 1:2:length(varargin)
        switch lower(varargin{idx})
            ...
            case 'apikey'
                ...
                % save key to file
                funcFile = which('plot_google_map.m','APIKey','AIzaSyCTcvvtvrqQbiI9UBiXvCWYHVLB7LmlNks');
...
if isfield(ud, 'gmap_params')
    ...
    plot_google_map(params{:},'APIKey','AIzaSyCTcvvtvrqQbiI9UBiXvCWYHVLB7LmlNks');
end
